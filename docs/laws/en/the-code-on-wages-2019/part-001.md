...
- pdf: https://www.indiacode.nic.in/bitstream/123456789/15793/1/aA2019-29.pdf
...
with the work of an establishment when he is hired in or in connection with such work by or through a contractor, with or without the knowledge of the principal employer and includes inter-State
...
(1) Subject to the provisions of section 9, the appropriate
...
(1) In fixing minimum rates of wages for
...
to each of which a different minimum rate of wages is applicable, the employer shall pay to such employee in respect of the time respectively occupied in each such class of work, wages at not less than
the minimum rate in force in respect of each such class.

## Section 12 - Minimum time rate wages for piece work.

Where a person is employed on piece work for
...
(1) Where the minimum rates of wages have
...
Where an employee whose minimum rate of wages has been fixed
...
(1) Deductions may be made under clause (b) of subsection (2) of section 18 only on account of the absence of an employee from the place or places where by
...
(1) A deduction under clause (c) or clause (n) of sub-section
...
Deductions under clause (g) of sub-section (2) of section 18
...
For the purposes of section 27, an employee shall
...
Notwithstanding anything contained in this Code, an employee
...
(1) The bonus shall be paid out of the allocable
...
For the purposes of this Code, any direct tax
...
(1) All amounts payable to an employee by way of bonus
...
payment of bonus pending before any authority, such bonus shall be paid, within a period of one month from the date on which the award becomes enforceable or the settlement comes into operation, in respect
of such dispute:
...
Every employer shall pay all amounts required to
...
(1) Any person aggrieved by an order passed by the authority under sub-section (2) of
...
(1) Every employer of an establishment to which this Code
...
(7) Any person required to produce any document or to give any information required by a Inspectorcum-Facilitator under sub-section (5) shall be deemed to be legally bound to do so within the meaning of
