...
(b) A hires Bs ship to go to Bombay, and there take on board, on the first of January, a cargo, which A is to provide, and to
bring it to Calcutta, the freight to be paid when earned. Bs ship does not go to Bombay, but A has opportunities of procuring
...
piece than that which he was to have paid to A, and is prevented from performing a contract which B had made with a third
...
(p) A contracts to sell and deliver 500 bales of cotton to B on a fixed day. A knows nothing of Bs mode of conducting his
...
[Transfer of ownership of thing sold, which has yet to be ascertained, made or finished.] Rep. by
s. 65, ibid.
...
[Transfer of ownership of moveable property, when sold together with immoveable.] Rep. by s. 65,
ibid.
...
[Lien where payment to be made at a future day, but no time fixed for delivery.] Rep. by s. 65,
ibid.

## Section 97 - Repealed.

[Sellers lien where payment to be made at future day, and buyer allows goods to remain in
...
[How seller may stop where instrument of title assigned to secure specific advance.] Rep. by s.
65, ibid.
...
[When buyer may refused to accept, if goods not ordered are sent with goods ordered.] Rep. by
s. 65, ibid.
...
[Right of seller as to rescission, on failure of buyer to pay price at time fixed.] Rep.by the Indian
...
(a) A, in consideration of B's discounting, at As request, bills of exchange for C, guarantees to B, for twelve months, the
...
The death of the surety operates, in
...
Where two persons contract with a third person to undertake a
...
Where there are co-sureties, a release by
...
Where two or more persons are co-sureties for the
...
^1In all cases of bailment the bailee is bound to take as much care
...
If the bailee makes any use of
...
## Section 156 - Effect of mixture, without bailor's consent, when the good can be separated.
...
It is the duty
of the bailee to return, or deliver according to the bailors directions, the goods bailed, without demand, as
...
^1If, by the default of the bailee,
...
A gratuitous bailment is terminated by the
...
If the bailor has no title to the
...
The pawnee shall not, in the absence of a contract to
...
subsequent time before the actual sale of them^1
...
^1Where a mercantile agent is, with the consent of the owner, in
...
If a third person wrongfully deprives the bailee
...
behalf of another, without such other persons authority, which, if done with authority, would have the
...
An agent is bound to conduct the business
...
## Section 215 - Right of principal when agent deals, on his own account, in business of agency without principals consent.
